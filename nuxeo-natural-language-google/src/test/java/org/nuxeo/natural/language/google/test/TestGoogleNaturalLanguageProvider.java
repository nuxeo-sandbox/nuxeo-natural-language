...
public class TestGoogleNaturalLanguageProvider {
    ...
    @Test
    public void testWordDocument() throws UnsupportedEncodingException, IOException {
    ...
    public void testProviderSentimentAndEntities() throws IOException, JSONException {
        ...
        if (entity == null) {
            entity = NaturalLanguageEntity.findEntityForName(entities, "Status Quo");
        }
        assertNotNull(entity);

        // Checking values of entities and mentions is not a super good idea after
        // all, since Google improves the NLP, and after some months this test
        // suddenly failed. For example, we tested that the entity type was
        // "OTHER", while it became "WORK_OF_ART". Then, this entity did not
        // have a "The Spectres" as mention, etc.
        // So we just do basic test, that the call worked and that's all
    ...
    public void testHasNativeClient() {
        ...
        GoogleNaturalLanguageProvider gnl = (GoogleNaturalLanguageProvider) naturalLanguageService.getProvider(
                "google");
